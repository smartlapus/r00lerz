...
public class PLSQL_Generator implements CodeGenerator {
	...
	public Map<String, String> generateRule(String rule, String realPath) throws RuleDefException {
		...
		try {//read the files generated by the compiler
	...
	public String generateRuleSet(String ruleSet, String realPath) {
		...
		try {//TODO::SHOULD BE REPLACED WITH TROWS LATER
			generator.runGenerator(srcGenPath);
		...
		try {//read the files generated by the compiler
			result = PLSQL_Generator.readFile(srcGenPath+"generatedcode.sql",Charset.defaultCharset());
			this.removeFiles();
		}catch (IOException e) {e.printStackTrace();}
	...
	public static void main(String[] args) throws RuleDefException {
